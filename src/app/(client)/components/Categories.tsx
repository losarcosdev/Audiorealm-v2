...
export const Categories = () => {
  ...
  return (
    <section className="flex flex-col gap-10 lg:gap-0 lg:flex-row py-5 lg:py-0 lg:h-screen max-w-7xl mx-auto justify-around items-center">
      {productCategories.map(({ image, category, url }) => (
        <Link
          ...
          active:scale-95 focus:outline-none focus:ring-2 focus:ring-teal-700 focus:ring-offset-2 group md:w-full m-1
          `}
        >
          <Image
            alt={category}
